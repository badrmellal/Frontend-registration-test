...
const navigation = [
  ...
  { name: 'All users', href: '/allusers', current: false },
  { name: 'Projects', href: '#', current: false },
  { name: 'Study', href: '/study', current: false },
  { name: 'Login', href: '/signing', current: false },
]
...
export default function Navbar() {
  ...
  useEffect(() => {
    // Fetching userData details from the backend
    fetch(`http://localhost:8080/api/userData/details`)
        .then(response => response.json())
        .then(data => setuserData(data))
        .catch(error => console.error('Error fetching userData details:', error));
}, []);
              ...
              <Disclosure.Panel className="md:hidden">
                ...
                <div className="border-t border-gray-700 pb-3 pt-4">
                  <div className="flex items-center px-5">
                    ...
                    {userData && (
                    <>
                      <div className="text-base font-medium leading-none text-white">{userData.userDataname}</div>
